...
get_header(); ?>
<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/inc/css/privacy-policy.css">
<section class="privacy-policy l-_hpx">
    <div class="container-fluid">
        <div class="wrapper">
            <div class="_content">
                <div class="pps">
                    <h2>Privacy Policy of VCM The Celebrity Source</h2>
                    <p>VCM The Celebrity Source operates the <a target="_blank"
                            href="<?php echo $redirect_url; ?>/">https://www.vcmthecelebrity<br>source.com/</a>
                        website, which provides the SERVICE.</p>
                    <p>This page is used to inform website visitors regarding our policies with the collection, use, and
                        disclosure of Personal Information if anyone decided to use our Service, the VCM The Celebrity
                        Source website. If you choose to use our Service, then you agree to the collection and use of
                        information in relation with this policy. The Personal Information that we collect are used for
                        providing and improving the Service. We will not use or share your information with anyone
                        except as described in this Privacy Policy. Our Privacy Policy was created with the help of the 
                        <a target="_blank" href="https://www.privacypolicytemplate.net/">Privacy Policy Template
                            Generator</a>.
                    </p>
                    <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions,
                        which is accessible at <a target="_blank"
                            href="<?php echo $redirect_url; ?>/">https://www.vcmthecelebrity<br>source.com/</a> ,unless
                ...
                <div class="pps">
                    <h2>Cookies</h2>
                    <p>Cookies are files with a small amount of data that is commonly used as an anonymous unique
                        identifier. These are sent to your browser from the website that you visit and are stored on
                        your computer’s hard drive. Our website uses these "cookies" to collect information and to
                        improve our Service. You have the option to either accept or refuse these cookies, and know when
                        a cookie is being sent to your computer. If you choose to refuse our cookies, you may not be
                ...
                <div class="pps">
                    ...
                    <p>Our Services do not address anyone under the age of 13. We do not knowingly collect personal
                        ...
                        information, please contact us so that we will be able to do the necessary actions.</p>
                </div>
                ...
                <div class="pps">
                    ...
                    <p>If you have any questions or suggestions about our Privacy Policy, do not hesitate to <a
                            target="_blank" href="<?php echo $redirect_url; ?>/contact-us/">contact us</a>.
                    </p>
                </div>
            </div>
        </div>
